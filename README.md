...
```
cd existing_repo
git remote add origin https://git.itainnova.es/bigdata/tfm-modelos-multimodales.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.itainnova.es/bigdata/tfm-modelos-multimodales/-/settings/integrations)
